    ...
    return (
      <div>
        ...
        <form onSubmit={this.handleSubmit}>
            First Name : <input type='text' name='firstname' onChange={this.handleInput} placeholder='Enter First Name'/> <br/>
            Last Name : <input type='text' name='lastname' onChange={this.handleInput} placeholder='Enter Last Name'/> <br/>
